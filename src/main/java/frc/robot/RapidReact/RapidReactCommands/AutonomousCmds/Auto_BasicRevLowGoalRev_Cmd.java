...
public class Auto_BasicRevLowGoalRev_Cmd extends SequentialCommandGroup {
  /** Creates a new BasicAuto_Cmd. */
  public Auto_BasicRevLowGoalRev_Cmd(
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new IntakeInNOut_Spd_Cmd(
          intakeInNOutSubSys,
          RobotSettings.Shooting.kShootLowGoalVel,
          RobotSettings.Shooting.kShootLwrLowGoalVel)
          .withTimeout(2)),
