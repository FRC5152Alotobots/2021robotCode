...
public class BasicAuto_Cmd extends SequentialCommandGroup {
  /** Creates a new BasicAuto_Cmd. */
  public BasicAuto_Cmd(
    ...
    addCommands(
      new DriveSubSys_Drive4Time_Cmd(driveSubSys, -0.4, 0, 0, 2.0, true),
    
      new IntakeArm_Spd_Cmd(intakeArmSubSys,-0.3, false)
        .withTimeout(0.5),

      new IntakeInNOut_Spd_Cmd(intakeInNOutSubSys, -0.2, 0.0)
        .withTimeout(1),
      ...
      new DriveSubSys_Drive4Time_Cmd(driveSubSys, -0.4, 0, 0, 4.0, true)
