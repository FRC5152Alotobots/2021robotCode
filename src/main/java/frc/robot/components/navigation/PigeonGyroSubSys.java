...
public class PigeonGyroSubSys extends SubsystemBase {
  /**
   * Creates a new NavXGyro.
   */
  private Pigeon2 m_Pigeon2Gyro;

  public PigeonGyroSubSys() {
  ...
  public double getGyroAngle(){
    return Math.IEEEremainder(m_Pigeon2Gyro.getYaw(), 360) * (NavXGyroSubSys_Constants.GyroReversed ? -1.0 : 1.0);
  }
