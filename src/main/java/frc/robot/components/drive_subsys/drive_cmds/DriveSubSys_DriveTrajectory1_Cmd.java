...
public class DriveSubSys_DriveTrajectory1_Cmd extends CommandBase {
  ...
  public DriveSubSys_DriveTrajectory1_Cmd(DriveSubSys driveSubSys) {
  ...
  public void execute() {
    ...
    m_DriveSubSys.Drive(
      ...
      adjustedSpeeds.omegaRadiansPerSecond, false, false, false);
  }
