...
public class DriveSubSys_DriveVariableTrajectory_Cmd extends CommandBase {
  ...
  public DriveSubSys_DriveVariableTrajectory_Cmd(
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("HeadingGoal", goal.poseMeters.getRotation().getDegrees());
  }
