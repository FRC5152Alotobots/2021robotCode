...
public final class Constants {
  public static final class RobotSettings{
    public static final class Drive{
      ...
      // Drive Max Speeds
      public static final double MaxDriveSubSysSpd   = 1.85;                  // m/s
    ...
    public static final class Climbing{
      public static final double kExtend2Rung2Pos = 500; //mm (Test)
      
      public static final double kRung2toRung3Angle = 55; // Degrees
        // 45+10 margin
      ...
      public static final double kRung3toRung4Angle = 260; // 250// Degrees
        // 225+10 margin
